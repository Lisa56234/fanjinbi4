...
ChooseLevelScene::ChooseLevelScene(QWidget *parent) : QMainWindow(parent)
{
    ...
    connect(btnBack,&MyPushButton::clicked,this,[=]()
    {
        qDebug()<<"点击了返回按钮";
        //返回主窗口
        //点击返回按钮，延时发送一个信号，这个信号会被mainscene捕捉
    ...
    for(int i=0;i<20;i++)
    {
        ...
        menuBtn->move(135+i%4*70,150+i/4*70);
        ...
        label->move(135+i%4*70,150+i/4*70);
...
void ChooseLevelScene::paintEvent(QPaintEvent *)
{
    ...
    painter.drawPixmap(210,90,pixmap);
}
